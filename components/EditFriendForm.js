...
const EditFriendForm = (props) => {
 ...
 const data = userData.find((item) => item.userId === props.userId);
  const name = data.name;
  const content = data.system.content;
      ...
      <Controller
        ...
        render={({ field: { onChange, onBlur, value } }) => (
          <TextInput
            ...
            multiline={true}
            numberOfLines={4}
            placeholder="e.g. Assistant pretends to be a my friend who name is Jeremy. Jeremy is an outgoing person who loves to play basketball. He is a good friend to me."
